 ...
 */
class PromotionalBanner extends BasePromotionalBanner
{

    public function save(Doctrine_Connection $conn = null) {
        if($this->isNew() && php_sapi_name() != 'cli' && !empty($_SERVER['REMOTE_ADDR'])){
            $this->setRank(PromotionalBanner::getMaxRank()+1);
        }
    ...
    {
        return '/uploads/images/promotional_banner';
    }

    public function getFilenameDirPath()
    {
        return sfConfig::get('sf_upload_dir').'/images/promotional_banner';
    }
