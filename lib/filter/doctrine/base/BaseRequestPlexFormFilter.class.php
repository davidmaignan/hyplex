...
abstract class BaseRequestPlexFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'elapsed_plex_request'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'elapsed_process_response' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'elapsed_plex_request'     => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'elapsed_process_response' => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'elapsed_plex_request'     => 'Number',
      'elapsed_process_response' => 'Number',
      'created_at'               => 'Date',
      'updated_at'               => 'Date',
    );
  }
