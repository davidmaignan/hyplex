...
class PlexFilterFlightReturn extends PlexFilterFlight implements PlexFilterInterface {
    ...
    public function displayFilterForm_html5() {
        ...
        $frmStr .= '<ul><li><span class="container bold">' . __("Take-off") . '</span>';
        $frmStr .= '<span class="min">' . __("Return flight") . '</span></li></ul>';
                            ...
                            <ul>
                                <li>
                                    <span class="span-4 last">
                                        <input type="checkbox" name="direct_flights" />
                                        <label for="direct_flights">Non stop</label>
                                    </span>
                                    <span class="min"><a>$235.99</a></span>
                                </li>
                            </ul>
                        </div>
         */
