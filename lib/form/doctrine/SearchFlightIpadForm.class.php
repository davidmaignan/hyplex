 ...
 * @author david
 */
class SearchFlightIpadForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'depart_time' => new sfWidgetFormChoice(array('choices' => self::$arTime,'default'=>8), array('class' => 'span-2 medium')),
            'return_date' => new sfWidgetFormInputText(array(), array('class' => 'span-3')),
            'return_time' => new sfWidgetFormChoice(array('choices' => self::$arTime,'default'=>8), array('class' => 'span-2 medium')),
            ...
            'number_adults' => new sfWidgetFormChoice(array(
                ...
                'default' => 0), array('class' => 'span-1 medium')),
            'number_children' => new sfWidgetFormChoice(array(
                'choices' => self::$arChildren,
                'default' => 0), array('class' => 'span-1 medium child_number')),
