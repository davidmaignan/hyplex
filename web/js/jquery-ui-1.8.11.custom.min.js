...
$.widget( "ui.slider2", $.ui.mouse, {

	widgetEventPrefix: "slide2",
	...
	_create: function() {
		...
		if ( o.range ) {
			...
			this.range = $( "<div></div>" )
                ...
                //var sizeTest = '100%';
                //alert(sizeTest);
                var valPercentTest = ( o.posMax - o.posMin ) / ( o.max - o.min ) * 100;

                if(valPercentTest > 92){
                    valPercentTest = 92;
                }

                //alert(valPercentTest);
                var leftTest = ((o.posMin - o.min)*100)/(o.max - o.min) -2  +'%';
                //alert(leftTest);
                //
                //100 - valPercent ) + "%";
                

                //<span class='ui-slider-customize-minPrice-sp'>"+o.posMin+"</span>
                //<span class='ui-slider-customize-maxPrice-sp'>"+o.posMax+"</span>

                this.price_range = $("<div></div>").
                                    appendTo(this.element).
                                    addClass('ui-slider-customize');
                                
                this.range_data_min = $("<div class='ui-slider-customize-minPrice-sp'>"+o.posMin+"</div>").
                                    appendTo(this.price_range).
                                    css('left',leftTest);

                this.range_data_max = $("<div class='ui-slider-customize-maxPrice-sp'>"+o.posMax+"</div>").
                                    appendTo(this.price_range).
                                    css('left',valPercentTest + '%');
