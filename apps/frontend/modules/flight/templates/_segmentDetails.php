...
<td class="airport"><?php echo html_entity_decode($result->getAirportName($data->DepartureFrom, $sf_user->getCulture())); ?></td>
...
<td class="airport"><?php echo html_entity_decode($result->getAirportName($data->ArrivalTo, $sf_user->getCulture())); ?></td>
</tr>
