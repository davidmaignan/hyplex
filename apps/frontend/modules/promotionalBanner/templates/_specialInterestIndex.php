...
<div class="prepend-top" id="specialInterest">
    ...
    <div id="specialInterest-container">
        <ul class="inline">
            ...
            <li><a><?php echo __('Luxury') ?></a></li>
            <li><a><?php echo __('Spa retreat') ?></a></li>
            <li><a><?php echo __('Condominiums') ?></a></li>
            <li><a><?php echo __('Family & kids') ?></a></li>
            <li><a><?php echo __('Winter sports') ?></a></li>
            <li><a><?php echo __('Sun / beach') ?></a></li>
